...
def main_entry(trinity_boot: BootFn,
    ...
    def kill_trinity_with_reason(reason: str) -> None:
        kill_trinity_gracefully(
            trinity_config,
            stderr_logger,
            (),  # TODO: networking_process, database_server_process
            plugin_manager,
            main_endpoint,
            reason=reason
        )
...
async def trinity_boot_coro(
        kill_trinity, main_endpoint, trinity_config, plugin_manager, args, extra_kwargs) -> None:
